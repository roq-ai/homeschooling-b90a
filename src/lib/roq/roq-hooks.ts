...
export function useGradeFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGradeFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.grade.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGradeCount<T extends Prisma.gradeCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.gradeCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGradeCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.grade.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGradeFindManyWithCount<
  T extends Prisma.gradeFindManyArgs,
  R extends { data: GetFindResult<Prisma.$gradePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.gradeFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGradeFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.grade.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGradeFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGradeFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.grade.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLessonFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLessonFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lesson.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLessonCount<T extends Prisma.lessonCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.lessonCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useLessonCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lesson.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLessonFindManyWithCount<
  T extends Prisma.lessonFindManyArgs,
  R extends { data: GetFindResult<Prisma.$lessonPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.lessonFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLessonFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lesson.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLessonFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLessonFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lesson.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
