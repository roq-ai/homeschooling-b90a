...
import { useRoqClient, useGradeFindManyWithCount } from 'lib/roq';
...
export function GradeListPage(props: GradeListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useGradeFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.grade.delete({ where: { id } });
      await mutate();
    } catch (error) {
