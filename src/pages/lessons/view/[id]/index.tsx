...
import { useLessonFindFirst, useRoqClient } from 'lib/roq';
...
function LessonViewPage() {
  ...
  const queryParams = useMemo<{ include: { assignment: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useLessonFindFirst(queryParams, {}, { disabled: !id });
