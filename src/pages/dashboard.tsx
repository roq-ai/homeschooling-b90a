...
import { useRoqPlatformUserProfiles, useLessonCount, useGradeCount, useAssignmentCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const lessonStat = useLessonCount();

  const gradeStat = useGradeCount();
